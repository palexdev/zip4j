...
import static io.github.palexdev.zip4j.util.BitUtils.isBitSet;
...
public class FileHeaderFactoryTest {
	...
	@Test
	public void testGenerateFileHeaderWhenEncryptingWithoutMethodThrowsException() {
		assertThrows(
				ZipException.class,
				() -> {
					ZipParameters zipParameters = generateZipParameters();
				...
				"Encryption method has to be set when encryptFiles flag is set in zip parameters"
		);
	}
	...
	@Test
	public void testGenerateFileHeaderWithAesEncryptionWithNullKeyStrengthThrowsException() {
		assertThrows(
				ZipException.class,
				() -> {
					ZipParameters zipParameters = generateZipParameters();
