...
import io.github.palexdev.zip4j.io.outputstream.CountingOutputStream;
import io.github.palexdev.zip4j.io.outputstream.SplitOutputStream;
import io.github.palexdev.zip4j.model.*;
import io.github.palexdev.zip4j.model.enums.*;
...
public class HeaderWriterIT extends AbstractIT {
	...
	public void testWriteLocalFileHeaderSimpleLocalFileHeaderSuccessScenario() throws IOException {
		...
		File headersFile = Files.createTempFile(temporaryFolder, "zip4j_test", "").toFile();
	...
	public void testWriteExtendedLocalFileHeaderWhenLocalFileHeaderIsNullThrowsException() {
		assertThrows(
				ZipException.class,
				() -> headerWriter.writeExtendedLocalHeader(null, new FileOutputStream(Files.createTempFile(temporaryFolder, "zip4j_test", "").toFile())),
	...
	@Test
	public void testFinalizeZipFileWhenZipModelNullThrowsException() {
		assertThrows(
				ZipException.class,
				() -> headerWriter.finalizeZipFile(null, new FileOutputStream(Files.createTempFile(temporaryFolder, "zip4j_test", "").toFile()), InternalZipConstants.CHARSET_UTF_8),
				"input parameters is null, cannot finalize zip file"
		);
	}

	@Test
	public void testFinalizeZipFileWhenOutputStreamIsNullThrowsException() {
		assertThrows(
				ZipException.class,
	...
	@Test
	public void testFinalizeZipFileWithoutValidationsWhenZipModelNullThrowsException() {
		assertThrows(
				ZipException.class,
				() -> headerWriter.finalizeZipFileWithoutValidations(null, new FileOutputStream(Files.createTempFile(temporaryFolder, "zip4j_test", "").toFile()), null),
				"input parameters is null, cannot finalize zip file"
		);
	}
	...
	@Test
	public void testUpdateLocalFileHeaderWhenFileHeaderIsNullThrowsException() {
		assertThrows(
				ZipException.class,
				() -> headerWriter.updateLocalFileHeader(null, new ZipModel(), new SplitOutputStream(Files.createTempFile(temporaryFolder, "zip4j_test", "").toFile())),
				"invalid input parameters, cannot update local file header"
		);
	}

	@Test
	public void testUpdateLocalFileHeaderWhenZipModelIsNullThrowsException() {
		assertThrows(
				ZipException.class,
				() -> headerWriter.updateLocalFileHeader(new FileHeader(), null, new SplitOutputStream(Files.createTempFile(temporaryFolder, "zip4j_test", "").toFile())),
				"invalid input parameters, cannot update local file header"
		);
	}
