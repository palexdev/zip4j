...
import io.github.palexdev.zip4j.testutils.HeaderVerifier;
...
@EnabledIfEnvironmentVariable(named = "ENABLE_SLOW_TESTS", matches = "true", disabledReason = "These require a lot of space and time to run")
