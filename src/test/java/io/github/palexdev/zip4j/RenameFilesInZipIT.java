...
import static io.github.palexdev.zip4j.testutils.HeaderVerifier.verifyFileHeadersExist;
...
public class RenameFilesInZipIT extends AbstractIT {
	...
	public void testRenameWithMapProgressMonitor() throws IOException, InterruptedException {
		TestUtils.copyFileToFolder(getTestFileFromResources("file_PDF_1MB.pdf"), temporaryFolder.toFile(), 100);
